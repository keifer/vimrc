""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" CSCOPE settings for vim - Raphanus's personal version
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"
...
if has("cscope")
    ...
    " Raphanus: If you'd like to use the default settins, uncomment the
    "           following codes.
    ...
    " Using CTRL-\ *twice* (intepreted as CTRL-@ by vim or CTRL-spacebar by
    " default) then a search type makes the vim window split horizontally,
    ...
    " Hitting CTRL-\ twice with the *capital* search type does a vertical split
